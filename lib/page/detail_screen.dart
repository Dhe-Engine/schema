...
import 'package:schema/page/add_todo_screen.dart';
import 'package:schema/page/edit_task_screen.dart';
            ...
            floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                Navigator.push(context,
                    MaterialPageRoute(
                      builder: (context) => AddToScreen(taskId: widget.taskId, heroIds: _hero),
                    ));
              },
              tooltip: 'New Todo',
